...
// ProfileWriter is set by runners to emit profiles generated by the harness.
...
func Main(ctx context.Context, loggingEndpoint, controlEndpoint string) error {
	...
	for {
		...
		go func() {
			...
			if isEnabled("cpu_profiling") && shouldRecord(req) {
				cpuProfBuf.Reset()
				traceBuf.Reset()
...
// decide if the incoming request is to be profiled
func shouldRecord(req *fnpb.InstructionRequest) bool {
	return req.GetProcessBundle() != nil
}
